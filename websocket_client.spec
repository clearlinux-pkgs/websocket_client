...
Source0  : https://files.pythonhosted.org/packages/bc/a6/5ef697df40e56459de75b57f302f2da92a51269925282a08e4eb76b16fb6/websocket-client-1.1.1.tar.gz
...
%prep
%setup -q -n websocket-client-1.1.1
cd %{_builddir}/websocket-client-1.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628215954
...
cp %{_builddir}/websocket-client-1.1.1/COPYING.LESSER %{buildroot}/usr/share/package-licenses/websocket_client/5dea8b07199dbcc7be918770ca7cef346f523214
cp %{_builddir}/websocket-client-1.1.1/LICENSE %{buildroot}/usr/share/package-licenses/websocket_client/5dea8b07199dbcc7be918770ca7cef346f523214
