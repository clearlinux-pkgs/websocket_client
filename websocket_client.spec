...
Source0  : https://files.pythonhosted.org/packages/0a/ce/971e8be0efe35d7bc2b0a5676ae8fa3c076fe269749d1d8671baa6d69730/websocket-client-1.2.0.tar.gz
...
%prep
%setup -q -n websocket-client-1.2.0
cd %{_builddir}/websocket-client-1.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628701371
...
cp %{_builddir}/websocket-client-1.2.0/LICENSE %{buildroot}/usr/share/package-licenses/websocket_client/5a7d7df655ba40478fae80a6abafc6afc36f9b6a
