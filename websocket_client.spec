...
Source0  : https://files.pythonhosted.org/packages/72/5a/8b6ce52468708a725c4b32b18cacad63150be0f523490bc888e27a795e4a/websocket_client-0.49.0.tar.gz
...
%prep
%setup -q -n websocket_client-0.49.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1534352388
